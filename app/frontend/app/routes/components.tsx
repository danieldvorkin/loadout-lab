...
export default function Components() {
  ...
  const componentTypes = Array.from(new Set(components.map(c => c.type))).sort();
  const manufacturers = Array.from(
    new Set(components.map(c => c.manufacturer.name))
  ).sort();
  ...
  }, [searchTerm, selectedType, selectedManufacturer, showAvailableOnly, components]);
